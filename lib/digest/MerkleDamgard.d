...
package class MerkleDamgard : Digest, IStatefulDigest
{
        private uint    bytes;
        ...
        ***********************************************************************/
        ubyte[] save(ubyte[] buf) {
                ...
                buf[0..bs] = (cast(ubyte*)&bytes)[0..bs];
                ne.bswapa32(buf[0..bs]);
                auto bufFill = bytes % buffer.length;
                buf[bs..bs+bufFill] = buffer[0..bufFill];
                return buf[0..bs+bufFill];
        }
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                The maximum required size to store current state.

        ***********************************************************************/

        size_t maxStateSize() { return bytes.sizeof+buffer.length; }
