/*******************************************************************************
        ...
        notice:         Copied from Tango, and modified for IStatefulDigest
        ...
        IStatefulDigest implemented by Ulrik Mikaelsson.
...
final class Tiger : MerkleDamgard, IStatefulDigest
{
        ...
        ***********************************************************************/
        ubyte[] save(ubyte[] buf) {
                ...
                buf[0..cs] = cast(ubyte[])context;
                ne.bswapa64(buf[0..cs]);
                const ns = npass.sizeof;
                buf[cs..cs+ns] = (cast(ubyte*)&npass)[0..ns];
                ne.bswapa32(buf[cs..cs+ns]);
                auto upper = super.save(buf[cs+ns..$]);
                return buf[0..cs+ns+upper.length];
        }
        ...
        ***********************************************************************/
        ...
        /***********************************************************************
                ...
                The Tiger-state can always be stored in exactly 28 bytes.

        ***********************************************************************/

        size_t maxStateSize() { return 28+super.maxStateSize; }
